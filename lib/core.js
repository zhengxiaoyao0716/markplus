...
var camel = function camel(str) {
    return '' + str.split('-').reduce(function (str, part) {
...
var CorePlugin = function CorePlugin(self, pkg) {
    ...
    return {
        ...
        code: function code() {
            return Render + 'Markplus.__defineGetter__(\'version\', () => \'' + pkg.version + '\');\n';
        },
        dump: function dump() {
...
var corePlugins = [[CorePlugin, _package2.default], _renderPromise2.default, _styleDefault2.default, _renderCode2.default];
