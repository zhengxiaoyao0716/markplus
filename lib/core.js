...
var CorePlugin = function CorePlugin(self) {
    if (!self.name) {
...
var corePlugins = [CorePlugin, _renderCode2.default, _renderPromise2.default];
...
var Markplus = function Markplus(elements, name, opts) {
    ...
    this.plugin = function () {
        ...
        var plugins = [].concat(corePlugins, _toConsumableArray(opts.plugin || [])).map(function (payload) {
            var plugin = payload instanceof Function ? payload : require('markplus-plugin-' + payload).default;
