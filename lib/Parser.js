    ...
    _createClass(Load, [{
        ...
        value: function dump() {
            ...
            var lines = this.size == 1 ? '' : this.lines.slice(1).map(exec ? function (line) {
                return line instanceof Element ? '' + JSON.stringify(line.json) : '(\n        ' + line + '\n    )';
            } : function (line) {
...
var Plain = exports.Plain = function (_Element5) {
    ...
    function Plain(line, at, mathced) {
        ...
        return _possibleConstructorReturn(this, (Plain.__proto__ || Object.getPrototypeOf(Plain)).call(this, 1, line, { mathced: mathced }, at));
    }
...
var Header = exports.Header = function (_Element6) {
    ...
    function Header(line, level, content, at) {
        ...
        _this6.id = _this6.content.trim().split(/[\s-]+/).join('-');
        return _this6;
    }
...
var Code = exports.Code = function (_Element7) {
    ...
    function Code(line, symbol, language, at) {
        _classCallCheck(this, Code);

        var _this7 = _possibleConstructorReturn(this, (Code.__proto__ || Object.getPrototypeOf(Code)).call(this, -1, line, { language: language }, at));
...
var Divider = exports.Divider = function (_Element8) {
    ...
    function Divider(line, at) {
        ...
        return _possibleConstructorReturn(this, (Divider.__proto__ || Object.getPrototypeOf(Divider)).call(this, 1, line, {}, at));
    }
        ...
        get: function get() {
            ...
            var map = function map(folded) {
                return folded.map(function (line) {
                    return line instanceof Array ? '<span class="Block">' + map(line) + '</span>' : line + '<br>';
                }).join('');
            };
...
var Parser = {
    ...
    HTMLElement: {
        enum: {
            pipe: function pipe(line, at) {
                return new (Divider.symbol.reduce(function (o, s) {
        ...
        pipe: function pipe(line, at) {
            ...
            var pipe = _extends({}, function (o) {
                ...
                return o[s] = function () {
                    return new Code(line, s, content, at);
                }, o;
            }, {}), function (o) {
                return o['>'.repeat(length)] = function () {
                    return new Block(line, length, at);
                }, o;
            }({}), {
                '': function _() {
    ...
    parse: function parse(lines) {
        ...
        lines.forEach(function (line, index) {
            ...
            if (ele.completed(line, at)) {
                elements.unshift(_this11.pipe(line, at));
                return;
            }
            ele.push(line, at);
        });
