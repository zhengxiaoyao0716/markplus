...
var withEscape = exports.withEscape = function withEscape(action) {
    return function (text) {
        return action(text.replace(/\\(.)/g, function (_, char) {
            return '\\u00' + char.charCodeAt(0).toString(16);
        })).replace(/\\u([0-9A-Za-z]{4})/g, function (_, code) {
...
var Table = exports.Table = function (_Element11) {
    ...
    function Table(line, at, content) {
        ...
        return _possibleConstructorReturn(this, (Table.__proto__ || Object.getPrototypeOf(Table)).call(this, -1, line, at));
    }
    ...
    parse: function parse(lines) {
        ...
        lines.forEach(function (line, index) {
            ...
            if (ele.completed(line, at)) {
                elements.unshift(_this13.pipe(line, at));
                return;
            }
            ele.push(line, at);
        });
